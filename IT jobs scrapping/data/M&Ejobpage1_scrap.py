...
#base_url = ""
url = ("https://www.timesjobs.com/candidate/job-search.html?searchType=Home_Search&from=submit&asKey=OFF&txtKeywords=&cboPresFuncArea=28")
...
df.to_excel("M&EJobsPage1_scrap.xlsx", index=False)
